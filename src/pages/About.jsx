...
const About = () => {
  return (
    <div>
      ...
      <p className="text-justify mt-2 spa" > Welcome to our Recipe Search SPA (Single Page Application), where culinary inspiration meets convenience! Our intuitive and user-friendly interface allows you to explore a vast world of delectable recipes effortlessly. Powered by a robust <Link isExternal showAnchorIcon href="https://rapidapi.com/apininjas/api/recipe-by-api-ninjas" color="primary">Recipes API</Link> our SPA enables you to search through an extensive database to discover a diverse array of culinary delights.
